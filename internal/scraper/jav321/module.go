...
func (m *scraperModule) Name() string        { return "jav321" }
func (m *scraperModule) Description() string { return "Jav321" }
...
func (m *scraperModule) ConfigFactory() any {
	return scraperutil.ConfigFactory(func() any { return &Jav321Config{} })
}
...
func (m *scraperModule) Priority() int { return 65 }

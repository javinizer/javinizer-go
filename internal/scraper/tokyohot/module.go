...
func (m *scraperModule) Name() string        { return "tokyohot" }
func (m *scraperModule) Description() string { return "Tokyo-Hot" }
...
func (m *scraperModule) ConfigFactory() any {
	return scraperutil.ConfigFactory(func() any { return &TokyoHotConfig{} })
}
...
func (m *scraperModule) Priority() int { return 50 }
...
func (m *scraperModule) FlattenFunc() any {
	return scraperutil.DefaultFlattenConfig(scraperutil.FlattenOverrides{BaseURL: "https://www.tokyo-hot.com"}, func(fc *scraperutil.FlattenedConfig, o scraperutil.FlattenOverrides) any {

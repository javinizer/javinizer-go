...
func (m *scraperModule) FlattenFunc() any {
	return scraperutil.DefaultFlattenConfig(scraperutil.FlattenOverrides{BaseURL: "http://dl.getchu.com"}, func(fc *scraperutil.FlattenedConfig, o scraperutil.FlattenOverrides) any {

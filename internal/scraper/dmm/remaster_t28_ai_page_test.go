...
func TestPageRemasterDisplayIDT28AISeries(t *testing.T) {
	...
	assert.Equal(t, "T-28123AI", pageRemasterDisplayID(doc, "t28123ai", "t", "ai", ""))
	assert.Equal(t, "T-28123H", pageRemasterDisplayID(doc2(t, "T-28123-HD"), "t28123h", "t", "h", ""))
	assert.Equal(t, "T28-123H", pageRemasterDisplayID(doc2(t, "T28-123-HD"), "9t28123h", "t28", "h", ""))
	...
	assert.Equal(t, "", pageRemasterDisplayID(doc2(t, "DV-818-AI"), "t28123ai", "t", "ai", ""))
}

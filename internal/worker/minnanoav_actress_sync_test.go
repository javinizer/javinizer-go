...
func TestSyncActressMetadataUsesMinnanoAVResolverWithoutLinkedMovies(t *testing.T) {
	...
	scraper := &metadataOnlyActressScraper{name: "minnanoav", info: models.ActressInfo{

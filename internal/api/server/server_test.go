...
func TestNewServer_RouteParity(t *testing.T) {
	...
	expected := []string{
		...
		"GET /api/v1/actresses/candidates",
		"GET /api/v1/actresses/collisions",
		"GET /api/v1/auth/status",
		"GET /api/v1/batch",
		"GET /api/v1/batch/:id",
		"GET /api/v1/batch/:id/results/:resultId/existing-nfo",
		...
		"POST /api/v1/actresses/candidates/:id/promote",
		"POST /api/v1/actresses/collisions/:id/resolve",
		"POST /api/v1/actresses/credits/:id/override",
		"POST /api/v1/actresses/credits/:id/suppress",
		...
		"POST /api/v1/batch/:id/results/:resultId/display-title-preview",

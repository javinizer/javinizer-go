...
func TestNewServer_RouteParity(t *testing.T) {
	...
	expected := []string{
		...
		"GET /api/v1/actresses/sync-jobs/active",
		"GET /api/v1/actresses/sync-jobs/:jobID",
		"GET /api/v1/actresses/sync-jobs/:jobID/tasks",
		...
		"POST /api/v1/actresses/sync-jobs",
		"POST /api/v1/actresses/sync-jobs/:jobID/cancel",

...
// ApplyFieldOverrideWithRevisions provides a mock function for the type MockBatchJobInterface
...
// MockBatchJobInterface_ApplyFieldOverrideWithRevisions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ApplyFieldOverrideWithRevisions'
type MockBatchJobInterface_ApplyFieldOverrideWithRevisions_Call struct {
	*mock.Call
}
...
func (_c *MockBatchJobInterface_ApplyFieldOverrideWithRevisions_Call) Run(run func(ctx context.Context, resultID string, fieldKey string, source string)) *MockBatchJobInterface_ApplyFieldOverrideWithRevisions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockBatchJobInterface_ApplyFieldOverrideWithRevisions_Call) Return(movieResult *resultstore.MovieResult, provenanceData *resultstore.ProvenanceData, stringToUint64 map[string]uint64, err error) *MockBatchJobInterface_ApplyFieldOverrideWithRevisions_Call {

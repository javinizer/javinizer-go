...
func TestResolverEnrichmentPerScraperOverrideBeatsGlobal(t *testing.T) {
	...
	assert.Equal(t, 1, enrichActressesFromResolvers(context.Background(), movie, newTestRegistry(resolver), &Config{ScrapeActress: false}, &[]string{}, nil))
	...
	assert.Equal(t, 0, enrichActressesFromResolvers(context.Background(), movie2, newTestRegistry(muted), &Config{ScrapeActress: true}, &[]string{}, nil))
...
func TestResolverEnrichmentActressFieldOverrideIsExclusive(t *testing.T) {
	...
	assert.Equal(t, 1, enrichActressesFromResolvers(context.Background(), movie, newTestRegistry(first, second), excl, &[]string{}, nil))
	...
	assert.Equal(t, 0, enrichActressesFromResolvers(context.Background(), movie2, newTestRegistry(first), skip, &[]string{}, nil))
...
func TestResolverEnrichmentContinuesPastResolverFailure(t *testing.T) {
	...
	assert.Equal(t, 1, enrichActressesFromResolvers(context.Background(), movie, newTestRegistry(offender, backup), &Config{ScrapeActress: true}, &[]string{}, nil))
...
func TestResolverEnrichmentExclusiveUnknownSelection(t *testing.T) {
	...
	assert.Equal(t, 0, enrichActressesFromResolvers(context.Background(), movie, newTestRegistry(resolver), cfg, &[]string{}, nil))
...
func TestResolverEnrichmentNilGuards(t *testing.T) {
	assert.Equal(t, 0, enrichActressesFromResolvers(context.Background(), &models.Movie{}, newTestRegistry(), nil, &[]string{}, nil))
	assert.Equal(t, 0, enrichActressesFromResolvers(context.Background(), nil, newTestRegistry(), &Config{ScrapeActress: true}, &[]string{}, nil))
	assert.Equal(t, 0, enrichActressesFromResolvers(context.Background(), &models.Movie{}, nil, &Config{ScrapeActress: true}, &[]string{}, nil))
}
...
func TestResolverEnrichmentContinuesWhenLaterResolverCanImprove(t *testing.T) {
	...
	assert.Equal(t, 1, enrichActressesFromResolvers(context.Background(), movie, newTestRegistry(lowerFirst, higherLater), cfg, &[]string{}, nil))
...
func TestResolverEnrichmentThreadsEarlierDiscoveries(t *testing.T) {
	...
	movie := &models.Movie{Actresses: []models.Actress{{DMMID: 7}}}
	assert.Equal(t, 1, enrichActressesFromResolvers(context.Background(), movie, newTestRegistry(discoverer, recorder), &Config{ScrapeActress: true}, &[]string{}, nil))
...
func TestCollectMetadataResolversExplicitSelectionIsExclusive(t *testing.T) {
	...
	enriched := enrichActressesFromResolvers(context.Background(), movie, registry, &Config{ScrapeActress: true}, &[]string{}, nil, []string{"dmm"})
